...
|---|---|---|---|
| |
| **(주)딜랏** | 2024.10 ~ 2025.09 | 테크 리더 (기술 총괄) | 웰니스 AI 서비스 전체 기술 설계 및 구현 총괄 |
| |
| **휴튼 (프로젝트)** | 2023.08 ~ 2024.09 | AI Engineer | LLM 기반 질문 생성·보정 엔진 개발 |
| |
| **키키아이주식회사** | 2022.08 ~ 2023.08 | Data Scientist / Web Developer | ERP 핵심 로직 및 웹 시스템 개발 |
...
|  |
|  |
| **[AI · LLM] LLM 기반 자기계발 질문 생성 서비스**<br>**휴튼 / 개인 프로젝트** |
| **프로젝트 유형**: AI 서비스 기획 · 모델 서빙 · 개인 프로젝트<br>**기간**: 2023.08 ~ 2024.09<br><br>📌 **개요**<br>사용자 상태·키워드를 기반으로 맞춤형 자기계발 질문을 생성·보정하는 LLM 기반 API 서비스 개발<br><br>🛠️ **사용 기술**<br>Python, PyTorch, FastAPI, HuggingFace, LangChain, Cafe24, KT Cloud NPU<br><br>🎯 **주요 역할**<br>- 키워드 기반 맞춤 질문 프롬프트 설계 및 LangChain 관리<br>- Function Calling으로 출력 구조 제어(병렬/고정 출력)<br>- 질문 중복 문제 해결을 위한 키워드 변경 기능 설계<br>- 키워드 클라우드 점수 시스템 고안<br>- BART 기반 질문 퀄리티 보정 SLM 개발<br>- KT Cloud NPU 서버 모델 서빙 및 배포 자동화<br><br>📊 **성과**<br>- 질문 평점 평균 **4.0X → 4.3X 상승**<br>- 추론 시간 **3초 내외 → 1초 이내 개선**<br>- 국가지원사업 기반 NPU 실서빙 경험 |
|  |
|  |
